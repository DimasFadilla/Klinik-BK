...
<!DOCTYPE html>
<html lang="en">
<head class="masthead bg-primary text-white text-center">
    <div class="container">
        <h1>Klinik {{ env('APP_NAME') }}</h1>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li><a href="{{ route('dokter.login') }}" class="nav-item mx-0 mx-lg-1"><i class="fas fa-user-md"></i> Login Dokter</a></li>
                <li><a href="{{ route('pasien.login') }}" class="nav-item mx-0 mx-lg-1"><i class="fas fa-user"></i> Login Pasien</a></li>
            </ul>
                </ul>
            </div>
        </div>
